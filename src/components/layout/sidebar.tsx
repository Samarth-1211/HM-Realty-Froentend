  ...
  return (
    <aside className="hidden w-64 shrink-0 flex-col border-r border-slate-100 bg-white lg:flex">
      <div className="flex h-16 items-center gap-2.5 border-b border-slate-100 px-5">
        ...
        <div>
          <p className="text-sm font-bold leading-tight text-slate-900">Real Estate CRM</p>
          <p className="text-[11px] leading-tight text-slate-400">Sales &amp; lead command center</p>
        </div>
      </div>
